...
def main():
    ...
    parser.add_argument("--model_id", type=str, default="water_MRPH_TimesNet_610", help="model id")
    parser.add_argument("--model", type=str, default="MRPH_TimesNet", help="model name")

    parser.add_argument("--data", type=str, default="custom", help="dataset type")
    parser.add_argument("--root_path", type=str, default="./dataset/", help="root path of the data file")
    parser.add_argument("--data_path", type=str, default="water_timeseries_610.csv", help="data file")
